...
public class Constants {
    ...
    public static float SHADOW_TIME = 280;//潜伏时间，14天为140
    ...
    public static int DIE_TIME = 10;//死亡时间均值，30天，从发病（确诊）时开始计时
    public static double DIE_VARIANCE = 1;//死亡时间方差
    /**
     * 城市大小即窗口边界，限制不允许出城
     */
    public static final int CITY_WIDTH = 800;
    public static final int CITY_HEIGHT = 800;


    public static float MASK_PROPORTION = 0.8f;
    public static float IMMUNE_RATE = 0.9f;
